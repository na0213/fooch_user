  ...
  <div class="flex py-8 px-6 md:flex">
    <div class="w-full">
      <div id="ownerFaq" class="container mx-auto my-4 py-5 px-4 border">
          <p class="pt-2 leading-relaxed font-semibold text-lblue text-sm md:text-base">Q：配送ステータスとはなんですか？</p>
          <p class="pt-2 leading-relaxed text-sm md:text-base">A：</p>
          <p class="pt-2 leading-relaxed text-sm md:text-base">
            ご購入商品の配送状況が確認できます。<br>
            店舗が商品を発送すると、「発送済」となります。<br>
            商品が到着しましたら、「発送済」ボタンを押して「配達完了」にステータスを変更してください。<br></p>
      </div>
    </div>
  </div>
</div>
