  ...
  <div class="flex py-8 px-6 md:flex">
    <div class="w-full">
      <div id="ownerFaq" class="container mx-auto my-4 py-5 px-4 border">
          <p class="pt-2 leading-relaxed font-semibold text-lblue text-sm md:text-base">Q：取引画面が使えないが店舗と連絡をとりたい</p>
          <p class="pt-2 leading-relaxed text-sm md:text-base">A：</p>
          <p class="pt-2 leading-relaxed text-sm md:text-base">
            店舗ページの、特商法、お問い合わせに記載の連絡先へ問い合わせをお願いいたします。<br>
            ご連絡いただくことは可能ですが、店舗の対応可否については当方では補償できかねます。<br></p>
      </div>
    </div>
  </div>
</div>
