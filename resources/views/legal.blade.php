  ...
  <div class="container mx-auto my-4 px-4 border">
    <div class="p-2 w-2/2 mx-auto">
      <p class="test leading-relaxed font-semibold">特定商取引法に基づく表記</p><br>
          <p class="test leading-relaxed indent-text">会員様がFOOCHをご利用になる際に必要な料金等をご案内いたします。</p><br><br>
          ...
          <p class="test leading-relaxed indent-text">入金確認後、１〜７日程度で発送</p><br><br>
          
          <p class="test leading-relaxed font-semibold">返品・交換について</p><br>
          <p class="test leading-relaxed indent-text">お客様都合による返品・交換は受け付けておりません。</p><br><br>       
    </div>
  </div>
